...
const Information = () => {
  ...
  return (
    <section id="akad" className="flex flex-col gap-10 place-content-center items-center py-10">
      ...
      <Button
        ...
        variant="flat"
        size="lg"
        startContent={<Icon icon="logos:google-calendar" fontSize={22} />}
        className="font-mono"
      >
      ...
      <div className="container-md flex max-md:flex-col gap-4">
        <Card className="w-full font-mono">
          <CardHeader className="pl-4 justify-between items-center">
            ...
            <Image alt="" src="/images/flower-005.webp" className="w-8" />
          </CardHeader>
          <Divider />
          <CardBody className="p-4 gap-2">
            <div className="text-xl">10:00 - 12:00</div>
            <div className="text-foreground-500">15 September 2024</div>
            <div>Perumahan Lipsum, Jl. Lorem Ipsum No. 1A, RT00/RW00, Kec. Dolor, Kab. Sit Amet.</div>
          </CardBody>
          <CardFooter>
              ...
              <div className="flex">
                ...
                >
                  <CardBody className="flex-row items-center gap-2 p-2 px-3">
                    <Icon icon="fxemoji:housebuilding" fontSize={18} />
